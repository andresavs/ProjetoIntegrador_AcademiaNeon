...
* Falando um pouco sobre a criação da Infra na AWS: 
    ...
    * Playbook aws_provisioning_vpc.yml 
        ...
        ![aws-provisioning-vpc](docs/aws-provisioning-vpc.png)
...
* Falando um pouco sobre a configuração das máquinas criadas:
    ...
    * install_docker_all-ec2.yml
    ...
    É necessário alterar a linha 14 nos dois arquivos acima, caso altere o nome das EC2.
    ...
    * install_jenkins_ec2-jenkins.yml
        Instala e configura o Jenkins na EC2 do Jenkins.

            Os itens abaixo podem/devem ser alterados:
